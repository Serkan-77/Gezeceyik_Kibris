...
// Turkish UI, KKTC location reference.
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_340px] lg:gap-14">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-10 rounded-sm border border-amber-200/60 bg-amber-50/70 px-4 py-3.5 text-sm leading-relaxed text-amber-800">
              <strong className="font-medium">Not:</strong> Bu sayfadaki açılış
              saatleri, fiyatlar ve iletişim bilgileri{' '}
              <strong className="font-medium">örnek veridir</strong> — bağımsız
          ...
          <section className="mt-16 border-t border-[#f5f2ee] pt-12" aria-labelledby="nearby-heading">
            <div className="mb-8">
              ...
              <p className="mt-1 text-sm text-[#9ca3af]">
                Bölgedeyken ziyaret etmeye değer diğer cazibe merkezleri.
              </p>
            </div>
